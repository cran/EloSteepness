...
#include "stanExports_multi_steep_original.h"

RCPP_MODULE(stan_fit4multi_steep_original_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_multi_steep_original")
