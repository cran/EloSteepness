...
#include "stanExports_multi_steep_fixed_sd_fixed_k.h"

RCPP_MODULE(stan_fit4multi_steep_fixed_sd_fixed_k_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_multi_steep_fixed_sd_fixed_k")
